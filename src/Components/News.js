              ...
              <div className="info-blog">
                ...
                <span className="meta">
                  <span className="author"
                    ><i className="fa fa-user"></i> Admin</span
                  >
                  <span className="date"
                    ><i className="fa fa-clock-o"></i> 2024-08-08</span
                  >
                </span>
              </div>
            </div>
            <div className="item col-md-4">
              ...
              <div className="info-blog">
                ...
                <span className="meta">
                  ...
                  >
                  <span className="date"
                    ><i className="fa fa-clock-o"></i> 2024-08-07</span
                  >
                </span>
              </div>
            </div>
            <div className="item col-md-4">
              ...
              <div className="info-blog">
                ...
                <span className="meta">
                  ...
                  >
                  <span className="date"
                    ><i className="fa fa-clock-o"></i> 2024-08-06</span
                  >
                </span>
        </div>
      </div>
